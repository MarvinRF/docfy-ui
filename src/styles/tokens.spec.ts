...
describe('deriveSurfaceTokens()', () => {
  ...
  it('never introduces a new hue — bgElevated and border are pure mixes of bg and text', () => {
    ...
    const { bgElevated, border } = deriveSurfaceTokens('#393E46', '#FFFAF3');
  ...
  it('returns deterministic output for the same input', () => {
    const a = deriveSurfaceTokens('#393E46', '#FFFAF3');
    const b = deriveSurfaceTokens('#393E46', '#FFFAF3');
    expect(a).toEqual(b);
  });
});
